...
export default function WebsiteDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const tabs = [
    ...
    { id: "status", label: "Status", icon: "solar:shield-check-bold-duotone" },
  ];
      ...
      <div className="flex items-center justify-between">
         <div className="flex items-center gap-4 flex-1 min-w-0">
           ...
           <div className="min-w-0">
             <h1 className="text-xl sm:text-2xl poppins-bold text-gray-900 leading-none truncate">Website Configuration</h1>
           </div>
         </div>
        <Button
          variant="secondary"
              ...
              <Cards>
                ...
                <CardContent className="space-y-6 pt-0">
                  <div className="flex items-center gap-6 p-4 rounded-2xl bg-gray-50/50 border border-gray-100">
                    <div className="w-16 h-16 rounded-[1.5rem] bg-white flex items-center justify-center border border-gray-100 overflow-hidden shadow-sm shrink-0">
                      {config.img ? (
                        <Image
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center justify-between bg-gray-50/50 p-4 rounded-xl border border-gray-100">
                      <span className="text-sm font-semibold text-primary truncate max-w-[200px] sm:max-w-md">{config.domain}</span>
                      <a href={config.domain} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors shrink-0">
                ...
                <CardContent className="space-y-6 pt-0">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="px-4 py-3 rounded-xl bg-emerald-50 text-emerald-600 border border-emerald-100 text-[10px] font-black uppercase tracking-widest flex items-center gap-2 h-full min-h-[54px]">
              ...
              <Cards>
                ...
                <CardContent className="space-y-6 pt-0">
                  <div className="p-6 rounded-2xl bg-indigo-500/5 border border-indigo-500/10 space-y-4">
                    <p className="text-xs font-medium text-indigo-600 leading-relaxed italic">
                      "Your website is verified and ready to be used as a knowledge base for your AI agents."
                    </p>
                    <div className="flex items-center gap-2">
                      <Icon icon="solar:check-circle-bold" className="text-emerald-500" width={16} />
                      <span className="text-[10px] font-bold text-gray-900 uppercase">SSL Configuration OK</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Icon icon="solar:check-circle-bold" className="text-emerald-500" width={16} />
                      <span className="text-[10px] font-bold text-gray-900 uppercase">Domain Ownership Verified</span>
                    </div>
                  </div>
                </CardContent>
              </Cards>
        ...
        <div className="space-y-8">
          ...
          <div className="p-8 rounded-[2.5rem] bg-gray-900 text-white space-y-6 relative overflow-hidden shadow-2xl">
            ...
            <div className="flex items-center gap-3 relative z-10">
              ...
              <h4 className="font-black text-[10px] uppercase tracking-widest">Global Status</h4>
            </div>
            <div className="space-y-2 relative z-10">
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-emerald-400" />
                <p className="text-[10px] font-black text-emerald-400 uppercase tracking-widest leading-none">VERIFIED</p>
              </div>
