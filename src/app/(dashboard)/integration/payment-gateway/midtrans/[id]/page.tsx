...
export default function MidtransDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const tabs = [
    ...
    { id: "configuration", label: "Configuration", icon: "solar:settings-bold-duotone" },
  ];
      ...
      <div className="flex items-center justify-between">
         <div className="flex items-center gap-4 flex-1 min-w-0">
           ...
           <div className="min-w-0">
             <h1 className="text-xl sm:text-2xl poppins-bold text-gray-900 leading-none truncate">Midtrans Configuration</h1>
           </div>
         </div>
        <Button
          variant="secondary"
                ...
                <CardContent className="space-y-6 pt-0">
                  <div className="space-y-1">
                    <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest ml-1">Webhook URL</p>
                     ...
                     <p className="text-[10px] text-muted-foreground italic ml-1 mt-2">Paste this URL in Midtrans Dashboard (Settings {' > '} Webhook).</p>
                  </div>
                </CardContent>
              </Cards>
            </>
