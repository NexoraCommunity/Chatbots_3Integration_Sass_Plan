      ...
      {/* Header with Back Button */}
       <div className="flex items-center gap-4">
         ...
         <div className="flex-1 min-w-0">
           <h1 className="text-xl sm:text-2xl poppins-bold text-gray-900 leading-none truncate">Add Midtrans</h1>
         </div>
       </div>
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <Cards>
              ...
              <CardContent className="space-y-6 pt-0">
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-[10px] text-muted-foreground italic ml-1">Give your integration a recognizable name for internal tracking.</p>
                </div>
              </CardContent>
            </Cards>
          )}
          ...
          {activeTab === "webhook" && (
            <Cards>
              ...
              <CardContent className="space-y-6 pt-0">
                <div className="p-6 rounded-2xl bg-indigo-50/50 border border-indigo-100/50 space-y-3">
                  ...
                  <p className="text-sm text-indigo-700/80 leading-relaxed">
                    Your unique Webhook URL will be generated automatically once the integration is created. You will need to copy that URL to your Midtrans Dashboard (Settings {' > '} Webhook) to receive transaction updates.
                  </p>
                </div>
              </CardContent>
            </Cards>
