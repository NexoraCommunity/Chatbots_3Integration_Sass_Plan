        ...
        >
          ...
          <div className="space-y-4">
            {xenditConfigs.length > 0 ? (
                      ...
                      >
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex items-center gap-3 min-w-0">
                            <div className="w-12 h-12 rounded-2xl bg-orange-500/10 flex items-center justify-center text-orange-600 border border-orange-500/20 shadow-sm shrink-0 group-hover:scale-110 transition-transform">
                              <Icon icon="simple-icons:xendit" width={28} />
                            </div>
              ...
              <EmptyIntegration
                icon="simple-icons:xendit"
                message="No Xendit configuration found yet"
              />
            )}
          </div>
        </motion.div>
