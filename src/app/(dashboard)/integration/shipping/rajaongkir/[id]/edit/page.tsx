...
export default function EditRajaOngkir({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleUpdate = () => {
    // Logic to update rajaongkir config
    router.back();
  };
    ...
    <div className="flex flex-col space-y-8  bg-[#FAFAFA] max-w-5xl mx-auto w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Cards>
            ...
            <CardContent className="space-y-6 pt-0">
              <div className="space-y-2">
                ...
                <Input
                  defaultValue="RajaOngkir Default"
                  variant="secondary"
              ...
              <div className="space-y-2">
                ...
                <Input
                  defaultValue="raja_xxxx_apikey_xxxx"
                  variant="secondary"
                  className="bg-gray-50/50 border-gray-100 focus:bg-white transition-all h-14 text-sm font-semibold"
                />
              </div>
        ...
        <div className="space-y-8">
          {/* Quick Info / Pro Tip */}
          <div className="p-6 rounded-[2rem] bg-teal-500/5 border border-teal-500/10 space-y-4">
            <div className="flex items-center gap-3">
              <div className="bg-teal-500 p-2 rounded-xl text-white">
                <Icon icon="solar:delivery-bold-duotone" width={20} />
              </div>
              <h4 className="font-bold text-teal-600 text-sm uppercase tracking-wider">Pro Tip</h4>
            </div>
            <p className="text-xs text-teal-600/70 leading-relaxed font-medium">
              Ensure you are using the correct account type (Starter, Pro, or Basic) as the features and endpoints vary significantly.
            </p>
          </div>
        </div>
      </div>
